    ...
    return (
        ...
        >
            <fieldset>
                ...
                DDD: <input type="text" value={ddd} onChange={e => setDdd(e.target.value)} /> <br />

                Numero: <input type="text" value={numeroTelefone} onChange={e => setNumeroTelefone(e.target.value)} /> <br />

                Tipo: <input type="text" value={tipoTelefone} onChange={e => setTipoTelefone(e.target.value)} /> <br />

                Ativo?: <input type="checkbox" checked={ativo} onChange={e => setAtivo(e.target.value)} /> <br />
